export const confirmEmail = (user, token) => {
    ...
    y="0px"
    viewBox="0 0 80 80"
    style="enable-background: new 0 0 80 80;height:100px;width:100px;margin: 30px auto;"
    xml:space="preserve"
>
    <style type="text/css">
        .st0 {
    ...
    <g>
        <path
            class="st0"
            d="M72.13,22.21c-0.16-2.15-0.34-4.3-0.51-6.44c-0.05-0.67-0.92-1.17-1.44-0.58c-0.97,1.1-2.54,0.36-3.49-0.38
...
>
<p>
    Se você não se cadastrou na rede RS Personal, por favor ignore este email
</p>`
}
